...
-Система скидок.
-Система торговли.
-Система проверки предмета, после чего заменяется на другой товар.
-Система переключения между магазинами.
-Перевод на 2 языка Русский/Английский.
-Привязка/Настройка кнопок.
-Обмен валют.
-Описание товаров.
-Покупка бафа карт таро.
-Статистика игрока во время открытого магазина, чтобы не закрывать его постоянно.

Да в основном хз что еще писать, это главный файл мода, повторю ради прикола что мод делает:
-Спавн мобов за баллы канала
-Перенос брони/хп/патронов/душ между уровнями
-Фикс многих багов уровней/игры
-Поддержка 2-х языков
-Сам магазин всякой хуйни, которая пригодится
-Понижено кол-во патронов в ящиках
-Повышенно золото на картах
-Повышен урон по игроку

В данный момент, данный мод находится под защитой компании ООО "РХК", просим НЕ редактировать глобально код, спасибо за понимание!
]]
